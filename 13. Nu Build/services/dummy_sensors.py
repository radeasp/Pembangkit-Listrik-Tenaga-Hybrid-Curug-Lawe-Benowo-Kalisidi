    ...
    def __init__(self):
        ...
        self.sensor_ranges = {
            ...
            'beban': {
                ...
                'ac_output_voltage': {'min': 219.0, 'max': 220.1, 'unit': 'V'},
                'ac_output_current': {'min': 1.9, 'max': 2.1, 'unit': 'A'},
            },
            'dump_load': {
                'picohydro_voltage': {'min': 13.9, 'max': 14.1, 'unit': 'V'},
                'picohydro_charging_current': {'min': 3.4, 'max': 3.6, 'unit': 'A'},
                'dumpload_voltage': {'min': 13.9, 'max': 14.1, 'unit': 'V'},
                'dumpload_current': {'min': 1.4, 'max': 1.6, 'unit': 'A'},
            },
            'environment': {
                'temperature': {'min': 25.0, 'max': 35.0, 'unit': '°C'},
                'humidity': {'min': 60.0, 'max': 90.0, 'unit': '%'},
                'pressure': {'min': 1005.0, 'max': 1015.0, 'unit': 'Pa'},
                'tma_value': {'min': 6.0, 'max': 8.0, 'unit': 'cm'},
                'rain_status': {'min': 0.0, 'max': 1.0, 'unit': ' '},
            }
        }
